...
# This took a ton of RAM to render, so I don't library full packages unless I
# need them. However, these are the package needed for this:
...
save_dir <- here::here("tidytuesday", "2019-39")
...
gganimate::animate(
  ...
  renderer = gganimate::gifski_renderer(
    fs::path(save_dir, "school_diversity_square.gif")
  ),
  start_pause = 0,
